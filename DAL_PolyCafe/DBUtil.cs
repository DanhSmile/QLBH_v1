...
namespace DAL_PolyCafe
{
    public class DBUtil
    {
        private static string connString = @"Data Source=DESKTOP-K038H12\SQLEXPRESS;Initial Catalog=Kimochi;Integrated Security=True;Trust Server Certificate=True";
